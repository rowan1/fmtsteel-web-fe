  ...
  const renderModal=()=>{
    return(
      <Modal
			...
			body={<ModalBody bodyElements={<p>
        FMT Steel provide a wide range of complete solutions which include tanks, pipelines, platforms, skids, C.I.P units, and etc. 
        We are always committed to providing the best for you, focusing on three characteristics: "Quality, Experience and uniqueness" by providing a highly skilled and experienced engineering team consisting of projects engineers, supervisors, site engineers, and craftsmen who are able to provide our customers with the highest quality service in both mechanical and electrical projects while satisfying the budget and timeframe specified for the project.
